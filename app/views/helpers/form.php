 ...
 */
	function input($fieldName, $options = array()) {
		...
		switch ($type) {
			...
			break;
			case 'email':
				$input = $this->emailField($fieldName, $options);
			break;
			case 'url':
				$input = $this->urlField($fieldName, $options);
			break;
			case 'number':
				$input = $this->numberField($fieldName, $options);
			break;
			case 'range':
				$input = $this->rangeField($fieldName, $options);
			break;
			case 'search':
				$input = $this->searchField($fieldName, $options);
			break;
			case 'text':
			case 'password':
			case 'file':
...
/**
 * Creates an email input widget.
 *
 * @param string $fieldName Name of a field, in the form "Modelname.fieldname"
 * @param array $options Array of HTML attributes.
 * @return string A generated HTML5 email input element
 * @access public
 */
	function emailField($fieldName, $options = array()) {
		$options = $this->_initInputField($fieldName, array_merge(
...
/**
 * Creates a URL input widget.
 *
 * @param string $fieldName Name of a field, in the form "Modelname.fieldname"
 * @param array $options Array of HTML attributes.
 * @return string A generated HTML5 URL input element
 * @access public
 */
	function urlField($fieldName, $options = array()) {
		$options = $this->_initInputField($fieldName, array_merge(
 ...
 * @param string $fieldName Name of a field, in the form "Modelname.fieldname"
 * @param array $options Array of HTML attributes.
 * @return string A generated HTML5 number input element
 * @access public
 */
	function numberField($fieldName, $options = array()) {
		$options = $this->_initInputField($fieldName, array_merge(
...
/**
 * Creates a range input widget.
 *
 * @param string $fieldName Name of a field, in the form "Modelname.fieldname"
 * @param array $options Array of HTML attributes.
 * @return string A generated HTML5 range input element
 * @access public
 */
	function rangeField($fieldName, $options = array()) {
		$options = $this->_initInputField($fieldName, array_merge(
...
/**
 * Creates a search input widget.
 *
 * @param string $fieldName Name of a field, in the form "Modelname.fieldname"
 * @param array $options Array of HTML attributes.
 * @return string A generated HTML5 search input element
 * @access public
 */
	function searchField($fieldName, $options = array()) {
		$options = $this->_initInputField($fieldName, array_merge(
			array('type' => 'search'), $options
		));
		return sprintf(
			$this->Html->tags['input'],
			$options['name'],
